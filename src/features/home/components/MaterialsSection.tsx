...
const materials = [
  { name: "Solid Oak", desc: "Straight grain, warm honey tones, exceptional durability", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&auto=format&fit=crop&q=90" },
  { name: "Walnut Wood", desc: "Deep chocolate hues, fine texture, mid-century warmth", image: "https://images.unsplash.com/photo-1572981779307-38b8cabb2407?w=600&auto=format&fit=crop&q=90" },
  { name: "Premium Teak", desc: "Natural oils, all-weather resilience, golden brown beauty", image: "https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?w=600&auto=format&fit=crop&q=90" },
  { name: "Linen & Velvet", desc: "Curated upholstery fabrics in timeless palettes", image: "https://images.unsplash.com/photo-1606744837616-56c9a5c08a68?w=600&auto=format&fit=crop&q=90" },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end mb-14">
            <motion.div variants={stagger(0, 0.12)} initial="hidden" animate={vis}>
              <motion.div variants={fadeUp} className="flex items-center gap-3 mb-4">
                ...
                <span className="font-body text-xs tracking-[0.25em] uppercase font-medium" style={{ color: "hsl(var(--orange))" }}>Materials</span>
              </motion.div>
            ...
            {materials.map((mat, i) => (
              <motion.div key={mat.name} {...cardReveal(i)} className="group relative overflow-hidden rounded-sm aspect-[3/4]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <p className="font-display font-bold text-white text-base mb-1">{mat.name}</p>
                  <p className="font-body text-xs text-white/50 leading-relaxed opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">{mat.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
