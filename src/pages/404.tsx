    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center text-center px-6" style={{ minHeight: "100vh", backgroundColor: "hsl(var(--warm-cream))" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h2 className="font-display font-bold text-foreground text-2xl mb-3">{t("notFound.title")}</h2>
          <p className="font-body text-muted-foreground text-sm mb-8 max-w-sm mx-auto">{t("notFound.description")}</p>
